"""
Django settings for pescavolution project.
...
SECRET_KEY = 'django-insecure-y7$$uv-)$&9am&4eo%a^yb7x_^*76(c-=a!x!%o72-0gq^gxcw'
...
WSGI_APPLICATION = 'pescavolution.wsgi.application'
